...
#define STD_CELL(CELL_ID, FIRST_R, C1, C2, C3)                                                     \
    PhysStdCell {                                                                                  \
        .id = CELL_ID,                                                                             \
        .crossbars =                                                                               \
            ChainedCrossbar(/* clang-format off */ /* It hates this template idk */            \
                std::array<PhysCrossbar,2>{   \
                                /* clang-format on */                                              \
                                PhysCrossbar{                                                      \
                                    .id = CELL_##CELL_ID##_BAR_0,                                  \
                                    .rows =                                                        \
                                        std::vector<RowCon>{                                       \
                                            RoutableRowCon{.parent_id = ROOT_BAR,                  \
                                                           .parent_col = C1},                      \
                                            RoutableRowCon{.parent_id = ROOT_BAR,                  \
                                                           .parent_col = C2},                      \
                                            RoutableRowCon{.parent_id = ROOT_BAR,                  \
